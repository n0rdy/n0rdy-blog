...
> **This is a vendored, self-maintained fork.**
>
> Upstream ([lukeorth/poison](https://github.com/lukeorth/poison)) has been
> unmaintained since September 2024.  This copy was previously a git submodule
> carrying local commits that were never pushed anywhere; it now lives directly
> in the blog repo and is maintained here.  There is no upstream to merge from.
>
